  ...
  import { UserFormData, FormProps } from "../interface";
  ...
  export default function UserForm({ data, onSave, onCancel }: FormProps<UserFormData>) {
  
    // 1. Usando useMemo para evitar que o objeto seja recriado em cada renderização
    ...
    // 2. Inicializando o estado com a tipagem explícita e garantindo que seja UserFormData
