...
interface InputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  ...
  error?: boolean;
  hint?: string;
  // autoComplete já está incluído via React.InputHTMLAttributes
}
...
const Input: FC<InputProps> = ({
  ...
  error = false,
  hint,
  // Adicione autoComplete e outras props que quiser suportar
  autoComplete,
  ...rest // Captura o restante das props nativas
}) => {
